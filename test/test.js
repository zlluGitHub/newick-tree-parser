 ...
 */
var Newick = require('../index.js').Newick
var NewickTools = require('../index.js').NewickTools
...
var tree = NewickTools.parse(treeString)
// init
...
var normalizedData = NewickTools.dfs(NewickTools.normalize(tree))
...
(function () {
    ...
    tree = NewickTools.map(tree, function (e) {
        e.length *= 10
        e.name += ' mapped'
        return e
    })
    var mappedDataTestResult = true
    var treeData = NewickTools.dfs(tree)
